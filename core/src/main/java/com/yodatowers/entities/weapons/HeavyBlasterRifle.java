...
public class HeavyBlasterRifle extends Weapon {
    public HeavyBlasterRifle(Texture projectileTexture, float attacksPerSecond, int damage) {
        super("Heavy Blaster Rifle", projectileTexture, attacksPerSecond, damage, 1, 8f, 14f, 1, 0f, 0f);
    }

    public HeavyBlasterRifle(Texture projectileTexture, float attacksPerSecond, int damage, ProjectileStyle projectileStyle) {
        super("Heavy Blaster Rifle", projectileTexture, attacksPerSecond, damage, 1, 8f, 14f, 1, 0f, 0f, projectileStyle);
    }
